            ...
            if are_fields_different:
                ...
                def show_popup_moments_pg_ratio():
                    ...
                    if len(span_lengths) == 2:
                        ...
                        st.markdown(f"**Minimales Moment M (B):** -{moment_M_b:.2f} kNm (Berechnet als: q * l^2 / n)")
                    ...
                    if len(span_lengths) == 3:
                        ...
                        st.markdown(f"**Minimales Moment M (B) und M (C):** -{moment_M_b:.2f} kNm (Berechnet als: q * l^2 / n)")
                    ...
                    if len(span_lengths) == 4:
                        ...
                        st.markdown(f"**Minimales Moment M (B) und M (D):** -{moment_M_b:.2f} kNm (Berechnet als: q * l^2 / n)")
                        st.markdown(f"**Minimales Moment M (C):** -{moment_M_c:.2f} kNm (Berechnet als: q * l^2 / n)")
                    ...
                    if len(span_lengths) == 5:
                        ...
                        st.markdown(f"**Minimales Moment M (B) und M (E):** -{moment_M_b:.2f} kNm (Berechnet als: q * l^2 / n)")
                        st.markdown(f"**Minimales Moment M (C) und M (D):** -{moment_M_c:.2f} kNm (Berechnet als: q * l^2 / n)")
            ...
            with colQuerkraft_2:
                ...
                if are_fields_different:
                    ...
                    if len(span_lengths) == 2:
                        ...
                        V_a_varia2 = 0.375 * g * l + 0.438 * p * l
                        ...
                        st.write(f":red[V(A) mit g/p Unterscheidung: {V_a_varia2:.2f} kN]")
                        st.write(f"Die Auflagerkraft V(B) beträgt: {V_b:.2f} kN")
                        st.write(f"Die Auflagerkraft V(C) beträgt: {V_c:.2f} kN")
                        st.write(f":red[V(A) mit g/p Unterscheidung: {V_c_varia2:.2f} kN]")
                    ...
                    def show_popup_forces_samefieldwidth():
                        ...
                        if len(span_lengths) == 2:
                            ...
                            st.markdown(f":red[**Nach Berechnungsverfahren 2 (s.Hinweise):** 0.375 * g * l + 0.438 * p * l = {V_a_varia2:.2f} kN]")
